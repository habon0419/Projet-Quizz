<div id="inscription-form" class="w-50 bgWhite container rounded  text-secondary py-2">
            ...
            <div class="inscription-form-body row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="border rounded-circle border-primary" style="width: 250px;height: 250px;margin: -50px 2px 4px 5px;background-color: #ffffff;"><img class="rounded-circle border-success" src="../assets/img/avatar1.png" style="width: 285px;height: 279px;margin: -17px 0px 0px -21px;"></div>
