  ...
  margin:6px 0px 0px 500px;
    ...
    <div style="background-color: #fefefe;width: 936px;height: 666px;margin: 30px -2px 7px 73px;padding: 0px;">
        <div class="d-flex" style="background-color: #51bfd0;height: 72px;">
            ...
            <button class="btn btn-primary" type="button" style="height: 39px;width: 134px;margin: 17px 0px 0px 0px;background-color: rgb(58,221,214);">Déconnexion</button></div>
        <div class="d-flex flex-row" style="margin: 31px 0px;">
            <div class="border rounded-0" style="height: 383px;background-color: #fefefe;width: 374px;margin: 21px 25px 0px 7px;">
                ...
                <div class="btn btn-warning btn-lg btn-block text-truncate border rounded-0 d-inline-flex" style="width: 373px;padding: 9px;height: 67px;"><a href="#" style="font-size: 25px;width: 310px;color: rgb(129,129,129);">Créer Admin</a><img src="assets/img/ic-ajout-active.png" style="width: 41px;height: 41px;"></div>
